...
CREATE FUNCTION retorno_nombre_materia_V2 ()
...
select dbo.retorno_nombre_materia_V2();
...
select dbo.retorno_nombre_materia_V3('DBA I');
...
CREATE FUNCTION suma_dos_num ()
	RETURNS INTEGER AS
	BEGIN
		RETURN (5+5);
	END;

SELECT dbo.suma_dos_num ();
